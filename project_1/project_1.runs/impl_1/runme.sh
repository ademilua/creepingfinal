...
HD_PWD='C:/Users/shree/OneDrive/Desktop/New folder/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log creeping_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source creeping_1.tcl -notrace
