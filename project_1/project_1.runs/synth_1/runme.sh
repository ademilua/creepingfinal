...
HD_PWD='C:/Users/shree/OneDrive/Desktop/New folder/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log creeping_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source creeping_1.tcl
