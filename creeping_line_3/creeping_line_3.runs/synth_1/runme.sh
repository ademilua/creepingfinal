...
HD_PWD='C:/Users/shree/OneDrive/Desktop/New folder/creeping_line_3/creeping_line_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log creeping_line_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source creeping_line_3.tcl
