...
HD_PWD='C:/Users/shree/OneDrive/Desktop/New folder/creeping_line_3/creeping_line_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log creeping_line_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source creeping_line_3.tcl -notrace
